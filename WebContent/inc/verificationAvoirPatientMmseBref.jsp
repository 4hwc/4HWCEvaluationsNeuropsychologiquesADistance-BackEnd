...
<div class="row">
  ...
  font-size:20px;
  padding:10px;
  margin: 10px 10px 0px 10px;">Aucun(e)patient(e) </div>
  ...
  margin:0px 10px 0px 10px;">
                  ...
                  <a class="btn btn-success btn-lg  btn-block "  href="<c:url value="/accueil_Medecin"/>" style="   text-align:center;"
						target="_blank" id="buttoncanvas"
						>  Vous n'avez pas de patient(es) pour effectuer ce test. <br /> Je souhaite trouver des patient(e)s. 
					<br />
...
var nombre_patients_string ="${patients.size()}";


var valeur = parseInt(nombre_patients_string);
	...
	//NAVIGATEUR DIFFERENT DE CHROME;
	 ...
	 var whitebgo = document.getElementById("white-background");
	  ...
	  whitebgo.style.display ="block";
	   ...
	   var msg = new SpeechSynthesisUtterance("Vous n'avez pas de patients ou patientes à votre charge.");
