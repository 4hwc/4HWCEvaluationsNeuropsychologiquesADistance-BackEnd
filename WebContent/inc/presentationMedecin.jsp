...
<!-- Barre de recherche-->
	...
	border: 8px #66FFFF solid;
        ...
        height:105px;">
                        ...
                        <form action="<c:url value="/recherches_Medecin"/>" class=" col-xs-12 ">
                        
                              
                               
                                    <div class="input-group col-xs-12">
                             
                                  <input type="text" id="inputrecherche"  class="elementrecherche form-control  input-lg" name="barre_recherche" placeholder="Votre recherche de médecins ou de patient(e)s par noms et / ou prénoms..." value="<c:out value="${formi.champ_recherche }"/>">
...
left:50%;" id ="start"><i class="fa fa-microphone"></i></button>
  ...
  border-color: #ecf0f1;
      ...
      <!-- Fin pop up -->
                ...
                <div class="col-xs-2">
                    ...
                    <div class="homemed">
                           ...
                           <a id="" class="btn-block "  href="<c:url value="/accueil_Medecin"/>"><span class=""></span>Accueil</a>
      ...
      <!-- prénoms+noms +photo+ déconnexion-->
      ...
      <!-- prénoms+noms -->
                ...
                <div class="col-xs-7">
                     ...
                     <div class="prenomsnomsmed">
                     
                     
                     <c:if test="${ ! empty sessionScope.sessionMedecin }">
                     
                     <a id="" class="btn-block "  href="<c:url value="/profil_Medecin?identifiant=${sessionScope.sessionMedecin.identifiant_medecin }"/>"> 
                     
                     
${sessionScope.sessionMedecin.prenoms_medecin }  ${sessionScope.sessionMedecin.noms_medecin }</a>
                ...
                <div class="col-xs-3">
                       ...
                       <div class="photomed" style="height:300px;">
                       
                       
                      <c:if test="${ ! empty sessionScope.sessionMedecin.url_photo_medecin }">
                       
                       <img class="" width="200" height="200" id="img" alt="ENAD" src="http://${  sessionScope.adresseserveur }:8080/enad${  sessionScope.sessionMedecin.url_photo_medecin }" >
                          
                       
                       
                       <a id="" class="btn-block " target="_blank" href="<c:url value="/photoMedecin"/>"> Modifier </a>
                ...
                <div class="col-xs-2">
                         ...
                         <c:if test="${ ! empty sessionScope.sessionMedecin }">
                                  ...
                                  <a id="enad_a" class="btn-block "  href="<c:url value="/deconnexionMedecin?identifiant=${sessionScope.sessionMedecin.identifiant_medecin }"/>"><span class="glyphicon glyphicon-log-out"></span> <br/>Déconnexion</a>
