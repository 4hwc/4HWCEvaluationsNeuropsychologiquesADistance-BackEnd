...
<body>
      ...
      var texte="S'il vous plaît, veuillez patienter qu'ENAD vous connecte au patient ${prenomsnomspatient } ...";
...
var texte="S'il vous plaît, veuillez patienter qu'ENAD vous connecte à la patiente ${prenomsnomspatient } ...";
      ...
      window.location='/enad/realisation_dessin_recopier_mmse?identifiantpatient=${identifiantpatient}&identifiantmedecin=${sessionScope.sessionMedecin.identifiant_medecin }&id_aleatoire=${id_aleatoiremmse }';
 ...
 $(document).ready(function() {
 	 $("body").load('/enad/attente_dessin_recopier?identifiantmed=${sessionScope.sessionMedecin.identifiant_medecin }&identifiantpat=${identifiantpatient }&id_aleatoire=${id_aleatoiremmse }');
