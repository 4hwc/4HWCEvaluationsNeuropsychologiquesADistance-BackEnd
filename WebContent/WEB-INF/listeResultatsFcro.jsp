...
<title>Résultats pour le test (Figure complexe de Rey-Osterrieth)</title>
...
<c:import url="/inc/enadnotice.jsp"/>
      ...
      <div class="row">
            ...
            <div class="col-xs-12">
                    ...
                    Résultats pour le test (Figure complexe de Rey-Osterrieth)
                ...
                <div class="col-xs-8">
                         ...
                         <div class="enad_con_med">
                             ...
                             <div class="col-xs-12 well" >
                                    ...
                                    <c:if test="${  empty SeancesDansDossierImagesFcro }">
                                    ...
                                    <c:if test="${ ! empty SeancesDansDossierImagesFcro }">
                                       ...
                                       <div class="row">
                                            ...
                                            <div class="titre_resultats_recherche_con_pat">
                                                 ...
                                                 <c:if test="${SeancesDansDossierImagesFcro.size()> 1 }">
                                                 
                                                     ${SeancesDansDossierImagesFcro.size() }
					                  ...
					                  var msg = new SpeechSynthesisUtterance("J'ai trouvé ${SeancesDansDossierImagesFcro.size() } résultat ");
                                      ...
                                      window.speechSynthesis.speak(msg);
                                            ...
                                            <div class="resultats_recherche_con_pat">
                                                ...
                                                <c:forEach items="${SeancesDansDossierImagesFcro }" var="listedeseancesfcro">
                                                
                                           <a class="btn-block" target="_blank"   href="<c:url value="/diaporama_fcro?idseance=${listedeseancesfcro.id_seance }"/>"> <c:out value=" Diaporama de la séance réalisée ${listedeseancesfcro.affichage_date_realisation_seance } avec  ${listedeseancesfcro.prenoms_noms_patient } de ${listedeseancesfcro.heure_realisation_seance } à ${listedeseancesfcro.heure_fin_seance }. "/></a>
