...
<title>Résultats pour le test (Trail Making Version 1)</title>
...
<c:import url="/inc/enadnotice.jsp"/>
      ...
      <div class="row">
            ...
            <div class="col-xs-12">
                    ...
                    Résultats pour le test (Trail Making Version 1)
                ...
                <div class="col-xs-8">
                         ...
                         <div class="enad_con_med">
                             ...
                             <div class="col-xs-12 well" >
                                    ...
                                    <c:if test="${  empty SeancesDansDossierImagesTmUn }">
                                    ...
                                    <c:if test="${ ! empty SeancesDansDossierImagesTmUn }">
                                       ...
                                       <div class="row">
                                            ...
                                            <div class="titre_resultats_recherche_con_pat">
                                                 ...
                                                 <c:if test="${SeancesDansDossierImagesTmUn.size()> 1 }">
                                                 
                                                     ${SeancesDansDossierImagesTmUn.size() }
					                  ...
					                  var msg = new SpeechSynthesisUtterance("J'ai trouvé ${SeancesDansDossierImagesTmUn.size() } résultat ");
                                      ...
                                      window.speechSynthesis.speak(msg);
                                            ...
                                            <div class="resultats_recherche_con_pat">
                                                ...
                                                <c:forEach items="${SeancesDansDossierImagesTmUn }" var="listedeseancesfcro">
                                                
                                           <a class="btn-block" target="_blank"   href="<c:url value="/diaporama_tm_un?idseance=${listedeseancesfcro.id_seance }"/>"> <c:out value=" Diaporama de la séance réalisée ${listedeseancesfcro.affichage_date_realisation_seance } avec  ${listedeseancesfcro.prenoms_noms_patient } de ${listedeseancesfcro.heure_realisation_seance } à ${listedeseancesfcro.heure_fin_seance }. "/></a>
