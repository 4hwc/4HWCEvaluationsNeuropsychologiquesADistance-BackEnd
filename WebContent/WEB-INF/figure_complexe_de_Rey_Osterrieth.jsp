...
<title>Figure complexe de Rey-Osterrieth</title>

<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta name="description" content="Figure Complexe de Rey-Osterrieth">
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-xs-12">
				...
				<div class="enad_ENAD">Figure complexe de Rey-Osterrieth</div>
			</div>
						...
						<div class="col-xs-12 ">
							...
							<div class="boutonseances">
								...
								<a class="btn-block buttonsmenu"
									href="<c:url value="/envoyer_fc_Rey_Osterrieth"/>">
									<br />Envoi du test </a>
					...
					<div class="row">
						...
						<div class="col-xs-12 ">
							...
							<div class="boutonseances">
								...
								<a class="btn-block buttonsmenu"
									href="<c:url value="/resultats_fc_Rey_Osterrieth"/>"><br />Liste de résultats</a>
