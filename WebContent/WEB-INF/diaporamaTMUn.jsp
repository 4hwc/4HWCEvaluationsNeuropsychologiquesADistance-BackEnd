...
window.speechSynthesis.speak(msgy);
                               ...
                               <a id="telecharger_resultatsbutton"   >Trail - Making Version 1 : Diaporama de  ${imagesdiaporama.size() } images.</a>
...
window.speechSynthesis.speak(msgy);
                               ...
                               <a id="telecharger_resultatsbutton"   >Trail - Making Version 1 : Image unique</a>
