...
var texte="S'il vous plaît, veuillez patienter qu'ENAD vous connecte à la patiente ${seance.prenoms_noms_patient } ...";
      ...
      window.location='/enad/realisation_tm_deux?identifiantpatient=${seance.identifiant_patient }&identifiantmedecin=${seance.identifiant_medecin }&identifiantutilisateur=${sessionScope.sessionMedecin.identifiant_medecin }&idseance=${seance.id_seance }';
 ...
 $(document).ready(function() {
 	 $("body").load('/enad/attente_tm_Medecin_deux?identifiantpatient=${seance.identifiant_patient }&identifiantmedecin=${seance.identifiant_medecin }&identifiantutilisateur=${sessionScope.sessionMedecin.identifiant_medecin }&idseance=${seance.id_seance }');
