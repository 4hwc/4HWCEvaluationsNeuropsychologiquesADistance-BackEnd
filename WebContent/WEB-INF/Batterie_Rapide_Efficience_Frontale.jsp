...
<title>Batterie Rapide d'Efficience Frontale (Dubois et Pillon)</title>

<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta name="description"
	content="Batterie Rapide d'Efficience Frontale (Dubois et Pillon)">
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-xs-12">
				...
				<div class="enad_ENAD">Batterie Rapide d'Efficience Frontale
					(Dubois et Pillon)</div>
			</div>
						...
						<div class="col-xs-12 ">
							...
							<div class="boutonseances">
								...
								<a class="btn-block buttonsmenu" target="_blank"
									href="<c:url value="/formulaire_batterie_rapide_efficience_frontale"/>"><br />Exécuter le test</a>
					...
					<div class="row">
						...
						<div class="col-xs-12 ">
							...
							<div class="boutonseances">
								...
								<a class="btn-block buttonsmenu" target="_blank"
									href="<c:url value="/resultats_batterie_rapide_efficience_frontale"/>"><br />Liste de résultats</a>
