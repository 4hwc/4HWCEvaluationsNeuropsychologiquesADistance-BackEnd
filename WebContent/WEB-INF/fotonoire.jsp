                      ...
                      <c:if test="${  main eq 'gauche'  }">
                                     ...
                                     <div class="col-xs-9">
                                       ...
                                       $(document).ready(function(){
                                    	   ...
                                    	   function downloadsendCanvas(link, canvaser, filename) {
                                    	   ...
                                    	   function GenerateFileAndDownload(canvaser){
                                    		   ...
                                    		   function nomnom(){
                                         		  ...
                                         		  var medpat = '${noms_prenoms_medpat}'; // Je reçois les noms et prénoms
                                                	  ...
                                                	  var date = new  Date();
                                  	  				...
                                  	  				var nomfinal ="fcro"+dateactuelle+"_"+idseance+"_"+medpat+"_.png";
                                     	...
                                     	document.getElementById('downloadandgivetodoctor').addEventListener('click', function() {
                    	  		    	    downloadsendCanvas(this, canvaser, nomnom()); 
                    	  		    }, false);
                           ...
                           document.getElementById('downloadandgivetodoctor').addEventListener('click',GenerateFileAndDownload(document.querySelector('#canvasfcromg')) , false);
                                             ...
                                             <canvas id="canvasfcromg"   width="800" height="500">
