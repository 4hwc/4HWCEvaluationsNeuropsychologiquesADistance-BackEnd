                                     ...
                                     <div class="col-xs-9">
                                       ...
                                       <div  class="row">
                                             ...
                                             function Actu(){
                                	  			...
                                	  			var tempsreel = setInterval(Actu(),1);
                                	  			
                                	  			
                                	  			console.log(tempsreel.getSeconds());
                                       ...
                                       $(document).ready(function(){
                                           ...
                                           function captureandsend(){
                             	  				...
                             	  				var year = tempsreel.getYear()+1900;

                             	  				var month = tempsreel.getMonth()+1;
                             	  				
                             	  			var nomfinal ="fcro"+"_dateheure_"+year+"_"+month+"_"+tempsreel.getDate()+"_"+tempsreel.getHours()+"_"+tempsreel.getMinutes()+"_"+tempsreel.getSeconds()+"_"+tempsreel.getMilliseconds()+"_"+idseance+"_"+medpat+"_.png";
