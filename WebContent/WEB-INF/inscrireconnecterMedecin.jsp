...
<title>Inscription ou Connexion du médecin</title>

<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta name="description"
	content="Le but est de permettre à un médecin de s'inscrire ou de se connecter.">
	...
	<c:import url="/inc/verificationNavigateur.jsp" />
		...
		<div class="row">
			...
			<div class="col-xs-12">
				...
				<div class="enad_ENAD">Médecin</div>
				...
				<div class="enad_background">
					...
					<div class="choix_1">
						...
						<a id="enad_a" class="btn-block"
							href="<c:url value="/inscription_Medecin"/>">Inscription</a>
					...
					<div class="choix_2">
						...
						<a id="enad_a" class="btn-block"
							href="<c:url value="/connexion_Medecin"/>">Connexion</a>
