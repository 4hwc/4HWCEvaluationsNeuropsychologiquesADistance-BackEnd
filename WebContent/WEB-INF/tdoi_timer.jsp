...
<!-- <c:import url="/inc/verificationTdoiImagesPresentes.jsp" />  -->
      ...
      <div id="white_background" style="display:none;
    width:100%;
    height:100%;
    position:fixed;
    top:0px;
  ...
  font-size:20px;
  padding:10px;
  margin: 10px 10px 0px 10px;">Aucune image </div>
  ...
  margin:0px 10px 0px 10px;">
                  ...
                  <a class="btn btn-success btn-lg  btn-block "  href="<c:url value="/telecharger_classer_images"/>" style="   text-align:center;"
						target="_blank" id="buttoncanvas"
						>  Vous n'avez pas d'images pour effectuer cette action. <br /> Il faut cliquer sur ce bouton pour insérer des images. 
					<br />
  ...
  border-color: #ecf0f1;" class="btn ">Fermer</button>
      ...
      var nombre_images_string ="${imagesdiaporama.size()}";


      var valeur = parseInt(nombre_images_string);

      if(valeur == 0){
       
      
      	 
      	 var whitebgo = document.getElementById("white_background");
      	  ...
      	  whitebgo.style.display ="block";
      	   ...
      	   var msg = new SpeechSynthesisUtterance("Aucune image");
      	   ...
      	   window.speechSynthesis.speak(msg);
                                 ...
                                 <div  id="head_slider">
                                     ...
                                     <a id="play" style="cursor:pointer;" class="hide" rel="tooltip" data-original-title="Je mets fin à la pause  du diaporama.">
                     ...
                     <div id="head_slider_content_list">
                             ...
                             <div id="head_slider_content">
                                    ...
                                    <img class="" id="img" alt="ENAD" height="500" width="820" src="<c:url value="/inc/patience.png"/>" > 
