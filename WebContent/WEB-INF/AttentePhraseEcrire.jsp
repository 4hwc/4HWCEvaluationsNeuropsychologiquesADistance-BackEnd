...
var texte="S'il vous plaît, veuillez patienter qu'ENAD vous connecte à la patiente ${prenomsnomspatient } ...";
      ...
      window.location='/enad/realisation_phrase_ecrire_mmse?identifiantpatient=${identifiantpatient}&identifiantmedecin=${sessionScope.sessionMedecin.identifiant_medecin }&id_aleatoire=${id_aleatoiremmse }';
 ...
 $(document).ready(function() {
 	 $("body").load('/enad/attente_phrase_ecrire?identifiantmed=${sessionScope.sessionMedecin.identifiant_medecin }&identifiantpat=${identifiantpatient }&id_aleatoire=${id_aleatoiremmse }');
