      ...
      <div class="container">
               ...
               <div class="row">
                     ...
                     <div class="col-xs-12">
                           ...
                           Upload de la photo de profil par le patient ${sessionScope.sessionPatient.prenoms_patient }  ${sessionScope.sessionPatient.noms_patient }
                         ...
                         Upload de la photo de profil par la patiente ${sessionScope.sessionPatient.prenoms_patient }  ${sessionScope.sessionPatient.noms_patient }
      ...
      <script type="text/javascript">
       ...
       $(document).ready(function(){
       	...
       	function SendFile(file){
       	    	 ...
       	    	 var url = '/enad/uploadimagesphotoprofilpatient';
       		   ...
       		   console.groupEnd();
       	    	 ...
       	    	 fd.append("upload_img_photopatient", file);  
       	    	 xhr.send(fd);
