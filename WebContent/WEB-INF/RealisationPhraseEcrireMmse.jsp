...
<body>
     ...
     <div class="container">
         ...
         var plusinfo = new SpeechSynthesisUtterance("Voulez-vous m'écrire une phrase,ce que vous voulez,mais une phrase entière.");
         ...
         window.speechSynthesis.speak(plusinfo);
                    ...
                    <div  class=" col-xs-1 btn-group-vertical btn-group-lg" >
                                                 ...
                                                 <a id="supprimer" class="btn btn-info  btn-lg" style="   height:80px;" rel="tooltip" data-original-title="Etat initial"><span class="glyphicon glyphicon-refresh"></span></a> 
               	...
               	largeurresponsive = (larg*1050)/1366;
               	 ...
               	 hauteurresponsivearrondie = Math.floor(hauteurresponsive);
                	   ...
                	   function uploadFile(file){
        	  		    	 ...
        	  		    	 var url = '/enad/captureimagemmselangage?idaleatoire=${id_aleatoire_mmse}';
        	  		    	 ...
        	  		    	 fd.append("upload_img_mmse_langage", file); //parameter : upload_img_mmse_langage
        	  		    	 xhr.send(fd);
                  	   ...
                  	   function downloadsendCanvas(link, canvaser) {
                      	      ...
                      	      function nomnom(){
                           		 ...
                           		 // var medpat = '${noms_prenoms_medpat}'; // Je reçois les noms et prénoms (sources de caractères spéciaux)
                           		        ...
                           		        var idaleatoire = '${id_aleatoire_mmse}';
                                  	  ...
                                  	  var date = new  Date();
                    	  				...
                    	  				var nomfinal ="phrase_ecrire"+dateactuelle+"_"+"ia"+"_"+idaleatoire+"_"+"m"+"_"+idmed+"_"+"p"+"_"+idpat+"_.png";
         ...
         var plusinf = new SpeechSynthesisUtterance("En attendant de recevoir le lien pour évaluer en temps réel, un moment de détente pour vous.");
...
// M 2
    ...
    balls.push(new Ball(offsetm+195, 53, 0, 0, a));
    
    
    balls.push(new Ball(offsetm+255, 53, 0, 0, a));
    
    balls.push(new Ball(offsetm+210, 68, 0, 0, a));
    balls.push(new Ball(offsetm+225, 83, 0, 0, a));
    
    balls.push(new Ball(offsetm+240, 68, 0, 0, a));
    
    
    
    balls.push(new Ball(offsetm+195, 68, 0, 0, a));
    balls.push(new Ball(offsetm+195, 73, 0, 0, a));
    balls.push(new Ball(offsetm+195, 88, 0, 0, a));
    balls.push(new Ball(offsetm+195, 103, 0, 0, a));
    balls.push(new Ball(offsetm+195, 118, 0, 0, a));
    balls.push(new Ball(offsetm+195, 133, 0, 0,a));
    balls.push(new Ball(offsetm+195, 143, 0, 0,a));
    
    balls.push(new Ball(offsetm+255, 68, 0, 0, a));
    balls.push(new Ball(offsetm+255, 83, 0, 0, a));
    balls.push(new Ball(offsetm+255, 98, 0, 0, a));
    balls.push(new Ball(offsetm+255, 113, 0, 0, a));
    balls.push(new Ball(offsetm+255, 128, 0, 0, a));
    balls.push(new Ball(offsetm+255, 133, 0, 0, a));
    balls.push(new Ball(offsetm+255, 143, 0, 0,a));
 ...
 // S
    ...
    balls.push(new Ball(oOffset + 205, 53, 0, 0, d));
    
    balls.push(new Ball(oOffset + 220, 53, 0, 0, d));
    balls.push(new Ball(oOffset + 235, 53, 0, 0, d));
    balls.push(new Ball(oOffset + 250, 53, 0, 0, d));
    balls.push(new Ball(oOffset + 265, 53, 0, 0, d));
    
    balls.push(new Ball(oOffset + 220, 143, 0, 0, d));
    balls.push(new Ball(oOffset + 235, 143, 0, 0, d));
    balls.push(new Ball(oOffset + 250, 143, 0, 0, d));
    balls.push(new Ball(oOffset + 265, 143, 0, 0, d));
    
    balls.push(new Ball(oOffset + 205, 68, 0, 0, d));
    balls.push(new Ball(oOffset + 205, 83, 0, 0, d));
    balls.push(new Ball(oOffset + 205, 98, 0, 0, d));
    
    balls.push(new Ball(oOffset + 265, 98, 0, 0, d));
    
    balls.push(new Ball(oOffset + 250, 98, 0, 0, d));
    balls.push(new Ball(oOffset + 235, 98, 0, 0, d));
    balls.push(new Ball(oOffset + 220, 98, 0, 0, d));
    ...
    balls.push(new Ball(oOffset + 265, 113, 0, 0, d));
    balls.push(new Ball(oOffset + 265, 128, 0, 0, d));
    balls.push(new Ball(oOffset + 265, 143, 0, 0, d));
    
    balls.push(new Ball(oOffset + 205, 143, 0, 0, d));
 ...
 // E
    ...
    balls.push(new Ball(oOffsete + 205, 53, 0, 0, c));
    
    balls.push(new Ball(oOffsete + 220, 53, 0, 0, c));
    balls.push(new Ball(oOffsete + 235, 53, 0, 0, c));
    balls.push(new Ball(oOffsete + 250, 53, 0, 0, c));
    balls.push(new Ball(oOffsete + 265, 53, 0, 0, c));
    
    balls.push(new Ball(oOffsete + 220, 143, 0, 0, c));
    balls.push(new Ball(oOffsete + 235, 143, 0, 0, c));
    balls.push(new Ball(oOffsete + 250, 143, 0, 0, c));
    balls.push(new Ball(oOffsete + 265, 143, 0, 0, c));
    
    balls.push(new Ball(oOffsete + 205, 68, 0, 0, c));
    balls.push(new Ball(oOffsete + 205, 83, 0, 0, c));
    balls.push(new Ball(oOffsete + 205, 98, 0, 0, c));
    
    balls.push(new Ball(oOffsete + 265, 98, 0, 0, c));
    
    balls.push(new Ball(oOffsete + 250, 98, 0, 0, c));
    balls.push(new Ball(oOffsete + 235, 98, 0, 0, c));
    balls.push(new Ball(oOffsete + 220, 98, 0, 0, c));
    ...
    //balls.push(new Ball(oOffset + 205, 83, 0, 0, c));
    //balls.push(new Ball(oOffset + 205, 98, 0, 0, c));
    balls.push(new Ball(oOffsete + 205, 113, 0, 0, c));
    balls.push(new Ball(oOffsete + 205, 128, 0, 0, c));
    balls.push(new Ball(oOffsete + 205, 143, 0, 0, c));
