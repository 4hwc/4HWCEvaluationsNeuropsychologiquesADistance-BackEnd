               	 ...
               	 hauteurresponsivearrondie = Math.floor(hauteurresponsive);
                      	      ...
                      	      function nomnom(){
                           		 ...
                           		 // var medpat = '${noms_prenoms_medpat}'; // Je reçois les noms et prénoms (sources de caractères spéciaux)
                                  	  ...
                                  	  var date = new  Date();
                    	  				...
                    	  				var nomfinal ="tm_deux"+dateactuelle+"_"+"s"+"_"+idseance+"_"+"m"+"_"+idmed+"_"+"p"+"_"+idpat+"_.png";
                   	...
                   	(function() {
                 	   ...
                 	   var positions_y = [];
                		 ...
                		 positions_x.push(765,600,800,770,350,650,500,220,350,400,650,60,200,50,60,120,425,470,800,657,1000,920,1000,980,770);
                 	  
                 	     positions_y.push(300,390,390,180,240,250,330,400,500,400,500,510,300,360,60,150,40,160,90,90,35,170,520,325,500);
                 	     
                 	     for(var k=0;k<positions_y.length;k++){
                           ...
                           ctxo.strokeStyle = "rgb(23, 145, 167)";
                    		...
                    		ctxo.arc(positions_x[k],positions_y[k], 30, 0, Math.PI * 2);  
                 	   ...
                 	   ctxo.strokeText("début", 765, 265);
                 	   
                 	  ctxo.strokeText("fin", 770, 465);
                 	  ...
                 	  for(var k=0;k<positions_y.length;k++){
                          ...
                          var b =a+"";
                   		...
                   		ctxo.fillText(b, positions_x[k]-8,positions_y[k]);
