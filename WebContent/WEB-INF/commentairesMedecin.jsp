...
<meta name="description" content="Commentaires effectués par le médecin">
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-xs-12">
				...
				<div class="enad_ENAD">Commentaires</div>
			</div>
						...
						<div class="col-xs-12 ">
							...
							<div class="boutonseances">
								...
								<a class="btn-block buttonsmenu"
									href="<c:url value="/creation_commentaires_Medecin"/>"><i
									class="fa fa-calendar"></i><br />Créer un commentaire</a>
					...
					<div class="row">
						...
						<div class="col-xs-12 ">
							...
							<div class="boutonseances">
								...
								<a class="btn-block buttonsmenu"
									href="<c:url value="/liste_commentaires_Medecin"/>"><i
									class="fa fa-calendar"></i><br />Liste des commentaires</a>
