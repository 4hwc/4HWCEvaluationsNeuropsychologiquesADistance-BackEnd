...
<title>Test de Dénomination Orale d'Images</title>

<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta name="description" content="Test de Dénomination Orale d'Images">
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-xs-12">
				...
				<div class="enad_ENAD">Test de Dénomination Orale d'Images</div>
			</div>
						...
						<div class="col-xs-12 ">
							...
							<div class="boutonseances">
								...
								<a class="btn-block buttonsmenu" target="_blank"
									href="<c:url value="/telecharger_classer_images"/>"><br />Upload d'images
									</a>
					...
					<div class="row">
						...
						<div class="col-xs-12 ">
							...
							<div class="boutonseances">
								...
								<a class="btn-block buttonsmenu" target="_blank"
									href="<c:url value="/presenter_images"/>"><br />Diaporama
									</a>
					...
					<div class="row">
						...
						<div class="col-xs-12 ">
							...
							<div class="boutonseances">
								...
								<a class="btn-block buttonsmenu" target="_blank"
									href="<c:url value="//imagesTdoiMiniature"/>"><br />Suppression des images
									</a>
