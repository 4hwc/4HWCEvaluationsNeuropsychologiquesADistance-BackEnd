...
<c:import url="/inc/enadnotice.jsp"/>
		...
		<br>
                          ...
                          <script type="text/javascript">
										...
										var msg = new SpeechSynthesisUtterance("Vous avez ${collegues.size() } collègues");
                                                                                   ...
                                                                                   <div class="form-group">
                                                                                             ...
                                                                                             <div class="row">
                                                                                                   ...
                                                                                                   <div class="resultats_recherche_con_pat">
                                                                                                      ...
                                                                                                      <c:forEach  items="${ collegues }" var="listedemedecins" >
