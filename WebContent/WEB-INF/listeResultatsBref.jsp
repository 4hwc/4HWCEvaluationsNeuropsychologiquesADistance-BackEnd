                ...
                <div class="col-xs-8">
					     ...
					     <div class="col-xs-12 ">
					           ...
					           <div class="boutonseances">
									...
									href="<c:url value="/resultats_bref_chrono_croissant"/>"><br />Ordre chronologique croissant </a>
					     ...
					     <div class="col-xs-12 ">
					           ...
					           <div class="boutonseances">
					                ...
					                <a class="btn-block buttonsmenu" target="_blank"
									href="<c:url value="/resultats_bref_chrono_decroissant"/>"><br />Ordre chronologique décroissant</a>
					     ...
					     <div class="col-xs-12 ">
					           ...
					           <div class="boutonseances">
					                ...
					                <a class="btn-block buttonsmenu" target="_blank"
									href="<c:url value="/resultats_bref_croissant"/>"><br />Ordre croissant basé sur le score total</a>
					...
					<div class="row">
					     ...
					     <div class="col-xs-12 ">
					           ...
					           <div class="boutonseances">
					                ...
					                <a class="btn-block buttonsmenu" target="_blank"
									href="<c:url value="/resultats_bref_decroissant"/>"><br />Ordre décroissant basé sur le score total</a>
					     ...
					     <div class="col-xs-12 ">
					           ...
					           <div class="boutonseances">
					                ...
					                <a class="btn-block buttonsmenu" target="_blank"
									href="<c:url value="/resultats_bref_patient"/>"><br />Patient(e)</a>
