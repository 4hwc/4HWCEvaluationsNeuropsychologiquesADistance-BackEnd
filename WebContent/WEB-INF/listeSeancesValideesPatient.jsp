...
<title>Liste des séances validées</title>

<meta http-equiv="X-UA-Compatible" content="IE=edge" >
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta name="description" content="Liste des séances validées">
                                   ...
                                   <div class="row">
                                          ...
                                          <div class="col-xs-12 ">
                                                     ...
                                                     <div class="boutonseancespat">
                                                              ...
                                                              <a class="btn-block buttonsmenu" href="<c:url value="/liste_seances_validees_suiv_Patient"/>"><br/>Liste des séances suivantes</a>
                                   ...
                                   <div class="row">
                                        ...
                                        <div class="col-xs-12 ">
                                                ...
                                                <div class="boutonseancespat">
                                                        ...
                                                        <a class="btn-block buttonsmenu" href="<c:url value="/liste_seances_validees_jour_Patient"/>"><br/>Liste des séances de ce jour</a>
                                   ...
                                   <div class="row">
                                        ...
                                        <div class="col-xs-12 ">
                                                ...
                                                <div class="boutonseancespat">
                                                        ...
                                                        <a class="btn-block buttonsmenu" href="<c:url value="/liste_seances_validees_prec_Patient"/>"><br/>Liste des séances précédentes</a>
