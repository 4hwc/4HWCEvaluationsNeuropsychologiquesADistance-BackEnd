...
<meta name="description" content="Liste des séances">
                                  ...
                                  <div class="menumed">
                                          ...
                                          <div class="row">
                                                 ...
                                                 <div class="col-xs-12 ">
                                                           ...
                                                           <a class="btn-block buttonsmenu" href="<c:url value="/liste_seances_validation_Medecin"/>"><br/>Liste des séances en attente de validation</a>
                                                           
                                                           <!-- href="<c:url value="/transitionLsmValidation?identifiant=${sessionScope.sessionMedecin.identifiant_medecin }"/>" -->
                                    ...
                                    <div class="col-xs-12 ">
                                           ...
                                           <div class="boutonseances">
                                                 ...
                                                 <a class="btn-block buttonsmenu" href="<c:url value="/liste_seances_validees_Medecin"/>"><br/>Liste des séances validées</a>
