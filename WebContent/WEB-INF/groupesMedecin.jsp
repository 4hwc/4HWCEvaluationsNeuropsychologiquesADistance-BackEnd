	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-xs-12">
				...
				<div class="enad_ENAD">Groupes</div>
			</div>
						...
						<div class="col-xs-12 ">
							...
							<div class="boutonseances">
								...
								<a class="btn-block buttonsmenu"
									href="<c:url value="/creation_groupes_Medecin"/>"><i
									class="fa fa-calendar"></i><br />Créer un groupe</a>
					...
					<div class="row">
						...
						<div class="col-xs-12 ">
							...
							<div class="boutonseances">
								...
								<a class="btn-block buttonsmenu"
									href="<c:url value="/liste_groupes_Medecin"/>"><i
									class="fa fa-calendar"></i><br />Liste des groupes</a>
