                         ...
                         <div class="menumed">
                             ...
                             <div class="row">
                                    ...
                                    <div class="col-xs-12 ">
                                              ...
                                              <a class="btn-block buttonsmenu" href="<c:url value="/creation_seances_Medecin?identifiant=${sessionScope.sessionMedecin.identifiant_medecin }"/>"><i class="fa fa-edit"></i><br/>Créer une séance</a>
                             ...
                             <div class="row">
                                    ...
                                    <div class="col-xs-12 ">
                                           ...
                                           <div class="boutonseances">
                                                 ...
                                                 <a class="btn-block buttonsmenu" href="<c:url value="/liste_seances_Medecin"/>"><i class="fa fa-columns"></i><br/>Liste des séances</a>
