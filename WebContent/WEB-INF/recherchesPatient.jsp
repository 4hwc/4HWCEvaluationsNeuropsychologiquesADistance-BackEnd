...
<c:import url="/inc/enadnotice.jsp"/>
		...
		<br>
                                              ...
                                              <div class="enad_con_pat">
                                                         ...
                                                         <form  class="col-xs-12 well"  >
                                                                   ...
                                                                   <fieldset>
                                                                           ...
                                                                           var msgu = new SpeechSynthesisUtterance("Aucun médecin ne correspond à votre recherche.");
                          ...
                          <c:if test="${! empty form.erreurs['barre_recherche'] }">
                                                                           ...
                                                                           <script type="text/javascript">
                                                                           var msg = new SpeechSynthesisUtterance("J'ai trouvé "+"${medecins.size() }"+" médecins.");
