        ...
        <div class="row"> 
         ...
         window.speechSynthesis.speak(plusinfo);
                                     ...
                                     <div class="col-xs-9">
                                               ...
                                               <div class="row">
                                                       ...
                                                       <nav class=" navbar navbar-inverse">
                                                             ...
                                                             <ul class="nav navbar-nav ">
                                                                  ...
                                                                  <li class="active"><a href="#">Dessin à recopier</a></li>
                                       ...
                                       $(document).ready(function(){
                                    	   ...
                                    	   function uploadFile(file){
                          	  		    	 ...
                          	  		    	 var url = '/enad/captureimagemmsepraxiesconstructives?idaleatoire=${id_aleatoire_mmse}';
                          	  		    	 ...
                          	  		    	 fd.append("upload_img_mmse_praxiesconstructives", file); //parameter : upload_img_mmse_praxiesconstructives 
                          	  		    	 xhr.send(fd);
                                        	      ...
                                        	      function nomnom(){
                                             		 ...
                                             		 // var medpat = '${noms_prenoms_medpat}'; // Je reçois les noms et prénoms (sources de caractères spéciaux)
                                                    	  ...
                                                    	  var date = new  Date();
                                      	  				...
                                      	  				var nomfinal ="dessin_recopier"+dateactuelle+"_"+"ia"+"_"+idaleatoire+"_"+"m"+"_"+idmed+"_"+"p"+"_"+idpat+"_.png";
                                     ...
                                     <div class="col-xs-3">
                                                           ...
                                                           <img class="imagedroite"  alt="Dessin à recopier" title="Dessin à recopier"
						src="<c:url value="/inc/recopier_dessin.JPG"/>">
