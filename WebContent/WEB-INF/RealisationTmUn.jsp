...
<body>
      ...
      <script type="text/javascript">
         ...
         var plusinfo = new SpeechSynthesisUtterance("Il faut relier dans le bon ordre.");
              ...
              <c:if test="${  sessionuser eq 'patient'  }">
               	...
               	largeurresponsive = (larg*1050)/1366;
               	 ...
               	 hauteurresponsivearrondie = Math.floor(hauteurresponsive);
               		...
               		document.getElementById('canvasfcromg').setAttribute('height',hauteur);
               		
               		document.getElementById('canvasfcromg').setAttribute('width',w);
                	   
                	   function uploadFile(file){
        	  		    	 
        	  		    	 var url = '/enad/captureimagetm?idseance=${id_seance}&type=${type_tm}';
        	  		    	 ...
        	  		    	 fd.append("upload_img_tm", file); //parameter : upload_img_tm
        	  		    	 xhr.send(fd);
                      	      ...
                      	      function nomnom(){
                           		 ...
                           		 // var medpat = '${noms_prenoms_medpat}'; // Je reçois les noms et prénoms (sources de caractères spéciaux)
                                  	  ...
                                  	  var date = new  Date();
                    	  				...
                    	  				var nomfinal ="tm_un"+dateactuelle+"_"+"s"+"_"+idseance+"_"+"m"+"_"+idmed+"_"+"p"+"_"+idpat+"_.png";
                   	...
                   	(function() {
                 	   ...
                 	   var positions_y = [];
                		 ...
                		 positions_x.push(546,788,990,778,798,262,252,516);
                 	  
                 	     positions_y.push(310,80,420,280,500,510,200,175);
                 	     ...
                 	     for(var k=0;k<8;k++){
                           ...
                           ctxo.strokeStyle = "rgb(23, 145, 167)";
                    		...
                    		ctxo.arc(positions_x[k],positions_y[k], 40, 0, Math.PI * 2);  
                    		
                    		ctxo.stroke();
                 	     }
                			
                 	    ctxo.strokeStyle = "rgb(23, 145, 167)"; 
                 	    ctxo.font = "bold 22pt Calibri,Geneva,Arial";
                 	   
                 	   ctxo.strokeText("début", 543, 260);
                 	   
                 	  ctxo.strokeText("fin", 516, 125);
                 	  ...
                 	  for(var k=0;k<8;k++){
                          ...
                          var b =a+"";
                   		...
                   		ctxo.fillText(b, positions_x[k],positions_y[k]);
                 	  ...
                 	  document.getElementById('supprimer').addEventListener('click', function() {
                        	  ...
                        	  //A la fin j'ai des cercles espacés, maintenant je les affiche
                       		 ...
                       		 positions_xx.push(546,788,990,778,798,262,252,516);
                        	  
                        	     positions_yy.push(310,80,420,280,500,510,200,175);
                        	     ...
                        	     for(var k=0;k<8;k++){
                                  ...
                                  ctxo.strokeStyle = "rgb(23, 145, 167)";
                           		...
                           		ctxo.arc(positions_xx[k],positions_yy[k], 40, 0, Math.PI * 2);  
                        	  ...
                        	  for(var k=0;k<8;k++){
                                 ...
                                 var pl =kl+"";
                          		...
                          		ctxo.fillText(pl, positions_xx[k],positions_yy[k]);
         ...
         var plusin = new SpeechSynthesisUtterance("En attendant de recevoir le lien pour évaluer en temps réel, un moment de détente pour vous.");
