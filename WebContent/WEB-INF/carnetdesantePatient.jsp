...
<meta name="description" content="Gestion du carnet de santé du patient">
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-xs-12">
				...
				<div class="enad_ENAD">Carnet de santé</div>
			</div>
						...
						<div class="col-xs-12 ">
							...
							<div class="boutonseancespat">
								...
								<a class="btn-block buttonsmenu"
									href="<c:url value="/telecharger_carnetdesante_Patient"/>"><i
									class="fa fa-calendar"></i><br />Télécharger</a>
					...
					<div class="row">
						...
						<div class="col-xs-12">
							...
							<div class="boutoncarnetdesantepat">
								...
								<a class="btn-block buttonsmenu"
									href="<c:url value="/consulter_carnetdesante_Patient"/>"><i
									class="fa fa-hospital-o"></i><br />Consulter</a>
