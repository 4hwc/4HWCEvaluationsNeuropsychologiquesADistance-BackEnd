...
<title>Résultats de votre recherche de patients et de médecins</title>
...
<c:import url="/inc/enadnotice.jsp"/>
		...
		<script type="text/javascript">
                                                                           var msgy = new SpeechSynthesisUtterance("J'ai trouvé ${medecins.size() }  médecins et  ${patients.size() } patients ou patientes.");
		    ...
		    <script type="text/javascript">
                                                                           var msgg = new SpeechSynthesisUtterance("Je n'ai pas trouvé de patients ou patientes mais j'ai trouvé "+"${medecins.size() }"+" médecins.");
		...
		<c:if test="${  empty medecins }">
		      ...
		      <script type="text/javascript">
                                                                           var msg = new SpeechSynthesisUtterance("Je n'ai pas trouvé de médecins mais j'ai trouvé "+"${patients.size() }"+" patients ou patientes.");
                          ...
                          <c:if test="${ empty medecins }">
                           ...
                           <div class="row">
                                                                ...
                                                                <div class="col-xs-12">
                                                                                         ...
                                                                                         Résultats de votre recherche de patients
                                                                                             ...
                                                                                             <div class="row">
                                                                                                   ...
                                                                                                   <div class="resultats_recherche_con_pat">
                                                                                                      ...
                                                                                                      <div class="col-xs-11">
                                                                                                       ...
                                                                                                       <a id="" class=""  href="<c:url value="/profil_Patient?identifiant=${listedepatients.identifiant_patient }"/>"> <c:out value="${listedepatients.prenoms_patient }    ${listedepatients.noms_patient }"/></a>
