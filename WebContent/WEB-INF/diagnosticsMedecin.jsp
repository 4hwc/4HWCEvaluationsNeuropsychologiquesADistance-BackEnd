...
<meta name="description" content="Diagnostics effectués par le médecin">
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-xs-12">
				...
				<div class="enad_ENAD">Diagnostics</div>
			</div>
						...
						<div class="col-xs-12 ">
							...
							<div class="boutonseances">
								...
								<a class="btn-block buttonsmenu"
									href="<c:url value="/creation_diagnostics_Medecin"/>"><i
									class="fa fa-calendar"></i><br />Créer un diagnostic</a>
					...
					<div class="row">
						...
						<div class="col-xs-12 ">
							...
							<div class="boutonseances">
								...
								<a class="btn-block buttonsmenu"
									href="<c:url value="/liste_diagnostics_Medecin"/>"><i
									class="fa fa-calendar"></i><br />Liste des diagnostics</a>
