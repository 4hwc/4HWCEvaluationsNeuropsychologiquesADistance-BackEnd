                                                                  ...
                                                                  <div class="modal-dialog modal-lg">
                                                                       ...
                                                                       <div class="modal-content">
                                                                           ...
                                                                           <div class="modal-body">
                                                                                 ...
                                                                                 <a class="btn btn-success btn-lg btn-block " href="<c:url value="/validation_seance_Patient?idSeance=${listedeseances.id_seance }"/>"><span class="glyphicon glyphicon-ok-sign"></span><br/>Je valide la séance.</a>
                                                                           ...
                                                                           <div class="modal-footer">
                                                                                ...
                                                                                <button class="btn btn-info" data-dismiss="modal">Je ne valide pas la séance.</button>
