                              ...
                              <c:if test="${  empty propseances }">
                                    ...
                                    <div class=row>
                                              ...
                                              <div class="enad_creer_seances">
                                                                                                               ...
                                                                                                               <form method="post" class="col-xs-12 well"  action="<c:url value="/creation_proposition_seances_Medecin"/>">
                                                                                        ...
                                                                                        <div class="modal-content">
                                                                                                ...
                                                                                                <div class="modal-body">
                                                                                                         ...
                                                                                                         <div class="enad_creer_seances">
                                                                                                               ...
                                                                                                               <form method="post" class="col-xs-12 well formpropositionspatient"  action="<c:url value="/creation_proposition_seances_Medecin"/>">
                                                                                              ...
                                                                                              <c:if test="${ ! empty validation }">
                                                                                                        ...
                                                                                                        <c:if test="${  validation eq 'oui' }">
                                                                                                              ...
                                                                                                              <c:if test="${ ! empty idseance }">
                                                                                                                       ...
                                                                                                                       <a class="btn btn-success btn-lg btn-block " href="<c:url value="/validation_proposition_seance_Medecin?idseance=${  idseance }"/>"><span class="glyphicon glyphicon-ok-sign"></span><br/>Je valide la dernière proposition.</a>
