...
<title>Envoi du test FCRO</title>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-xs-12">
				...
				<div class="enad_ENAD">Envoi du test (Figure complexe de
					Rey-Osterrieth)</div>
			</div>
