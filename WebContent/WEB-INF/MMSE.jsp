...
<title>Mini Mental State Examination (MMSE) (Version
	consensuelle du GRECO)</title>

<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta name="description"
	content="Mini Mental State Examination (MMSE) (Version consensuelle du GRECO)">
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-xs-12">
				...
				<div class="enad_ENAD">Mini Mental State Examination (MMSE)
					(Version consensuelle du GRECO)</div>
			</div>
						...
						<div class="col-xs-12 ">
							...
							<div class="boutonseances">
								...
								<a class="btn-block buttonsmenu" target="_blank"
									href="<c:url value="/formulaire_mmse"/>"><i
									class="fa fa-calendar"></i><br />Exécuter le test</a>
					...
					<div class="row">
						...
						<div class="col-xs-12 ">
							...
							<div class="boutonseances">
								...
								<a class="btn-block buttonsmenu" target="_blank"
									href="<c:url value="/resultats_mmse"/>"><i
									class="fa fa-calendar"></i><br />Liste de résultats</a>
