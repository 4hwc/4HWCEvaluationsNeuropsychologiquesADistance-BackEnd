...
<c:import url="/inc/enadnotice.jsp"/>
      ...
      <div class="row">
            ...
            <div class="col-xs-12">
                    ...
                    Résultats pour le test (TRAIL - MAKING)
					...
					<div class="row">
					     ...
					     <div class="col-xs-12 ">
					           ...
					           <div class="boutonseances">
									...
									href="<c:url value="/resultats_trail_making_un"/>"><br />Résultats Version 1</a>
					...
					<div class="row">
					     ...
					     <div class="col-xs-12 ">
					           ...
					           <div class="boutonseances">
					                ...
					                <a class="btn-block buttonsmenu"
									href="<c:url value="/resultats_trail_making_deux"/>"><br />Résultats Version 2</a>
