                         ...
                         <strong style=" font-size: 1em;"> <i class="fa fa-spinner fa-spin fa-3x fa-fw" aria-hidden="true" aria-hidden="true"></i></strong>
                                ...
                                <div id="head_slider_content_list">
                                       ...
                                       <div id="head_slider_content">
                                            ...
                                            <div id ="${boucle.index}">${images.url_image_langage_mmse}</div>
                                            
                                           <a id="nom${boucle.index}" >${images.nom_image_langage_mmse}</a>
...
window.speechSynthesis.speak(msgy);
                               ...
                               <a id="telecharger_resultatsbutton"   >Langage : Diaporama de  ${imagesdiaporama.size() } images.</a>
...
window.speechSynthesis.speak(msgy);
                               ...
                               <a id="telecharger_resultatsbutton"   >Langage : Image unique</a>
