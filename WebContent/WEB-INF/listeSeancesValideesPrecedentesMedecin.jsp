...
<title>Liste des séances précédentes</title>

<meta http-equiv="X-UA-Compatible" content="IE=edge" >
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta name="description" content="Liste des séances précédentes">
                ...
                <div class="col-xs-8">
                   ...
                   <div class="validees">
                                ...
                                <c:if test="${  empty seances }">
                                       ...
                                       Aucune séance validée précédente
                                       
                                       <script type="text/javascript">
										
										var msgy = new SpeechSynthesisUtterance("Aucune séance validée précédente");
                                ...
                                <c:if test="${ ! empty seances }">
                                     ...
                                     <script type="text/javascript">
										...
										var msgt = new SpeechSynthesisUtterance("J'ai trouvé une séance précédente");
										
										msgt.lang = 'fr-FR';
												
											
                                        window.speechSynthesis.speak(msgt);
                                     ...
                                     <script type="text/javascript">
										...
										var msg = new SpeechSynthesisUtterance("J'ai trouvé ${seances.size() } séance précédente");
