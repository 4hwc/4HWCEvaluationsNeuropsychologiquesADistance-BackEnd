                                                                                             ...
                                                                                             <div class="row">
                                                                                                   ...
                                                                                                   <div class="resultats_recherche_con_pat">
                                                                                                      ...
                                                                                                      <div class="col-xs-11">
                                                                                                       ...
                                                                                                       <a id="" class="" target="_blank"  href="<c:url value="/resultats_mmse_patient_unique?identifiant=${listedepatients.identifiant_patient }"/>"> <c:out value="${listedepatients.prenoms_patient }    ${listedepatients.noms_patient }"/></a>
