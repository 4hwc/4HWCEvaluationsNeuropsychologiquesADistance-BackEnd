...
<title>Envoi du test TRAIL - MAKING</title>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-xs-12">
				...
				<div class="enad_ENAD">Envoi du test TRAIL - MAKING
					...
					<div class="row">
					     ...
					     <div class="col-xs-12 ">
					           ...
					           <div class="boutonseances">
									...
									href="<c:url value="/envoyer_trail_making_un"/>"><br />Test Version 1</a>
					...
					<div class="row">
					     ...
					     <div class="col-xs-12 ">
					           ...
					           <div class="boutonseances">
					                ...
					                <a class="btn-block buttonsmenu"
									href="<c:url value="/envoyer_trail_making_deux"/>"><br /> Test Version 2</a>
