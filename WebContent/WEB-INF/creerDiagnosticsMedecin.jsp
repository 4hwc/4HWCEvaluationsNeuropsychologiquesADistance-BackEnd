...
<html>
<head>
<title>Création de diagnostics</title>

<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta name="description" content="Création de diagnostics">
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-xs-12">
				...
				<div class="enad_ENAD">Création de diagnostics</div>
		...
		<div class="row">
			...
			<div class="col-xs-8">
				...
				<div class="enad_creer_diagnostics">

					<form method="post" class="col-xs-12 well"
						action="<c:url value="/creation_diagnostics_Medecin"/>">
