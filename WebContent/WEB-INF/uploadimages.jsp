...
var msgy = new SpeechSynthesisUtterance("Il est conseillé d'enregistrer 10 images maximum simultanément.");
...
window.speechSynthesis.speak(msgy);
               ...
               <div class="row">
                     ...
                     <div class="col-xs-12">
                           ...
                           Upload des images par le médecin ${sessionScope.sessionMedecin.prenoms_medecin }  ${sessionScope.sessionMedecin.noms_medecin }
               ...
               <div class="row">
                     ...
                     <div class="col-xs-12">
                           ...
                           S'il vous plaît, il faut nommer convenablement vos fichiers - avant l'upload - afin de gérer facilement ces derniers lors des tests.
                           
                           <br>
                           
                           La taille maximale d'un fichier c'est 1 Mo.
                           
                           <br>
                           
                           
                           Nous vous conseillons d'enregistrer 10 images maximum simultanément.
               ...
               <div class="row">
                     ...
                     <div class="col-xs-12">
                                ...
                                <input type="file" class="form-control" id="fileinput" multiple="multiple" accept="image/*" >
