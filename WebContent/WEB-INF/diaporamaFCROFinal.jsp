                     ...
                     <div id="head_slider_content_list">
                             ...
                             <div id="head_slider_content">
                                   ...
                                   <div class="hide">
                                            ...
                                            <div id ="${boucle.index}">${images.url_img_fcro}</div>
                                            
                                           <a id="nom${boucle.index}" >${images.nom_img_fcro}</a>
...
window.speechSynthesis.speak(msgy);
                               ...
                               <a id="telecharger_resultatsbutton"   >Figure Complexe de Rey-Osterrieth : Diaporama de  ${imagesdiaporama.size() } images.</a>
...
window.speechSynthesis.speak(msgy);
                               ...
                               <a id="telecharger_resultatsbutton"   >Figure Complexe de Rey-Osterrieth : Image unique</a>
