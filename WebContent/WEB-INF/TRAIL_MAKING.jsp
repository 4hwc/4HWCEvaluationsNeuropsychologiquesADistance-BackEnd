...
<meta name="description" content="TRAIL - MAKING">
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-xs-12">
				...
				<div class="enad_ENAD">TRAIL - MAKING</div>
			</div>
						...
						<div class="col-xs-12 ">
							...
							<div class="boutonseances">
								...
								<a class="btn-block buttonsmenu"
									href="<c:url value="/envoyer_trail_making"/>"><br />Envoi du test</a>
					...
					<div class="row">
						...
						<div class="col-xs-12 ">
							...
							<div class="boutonseances">
								...
								<a class="btn-block buttonsmenu"
									href="<c:url value="/resultats_trail_making"/>"><br />Liste de résultats</a>
