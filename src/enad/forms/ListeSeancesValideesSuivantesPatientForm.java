...
public final class ListeSeancesValideesSuivantesPatientForm {
	...
	public ListeSeancesValideesSuivantesPatientForm(SeanceDao seanceDao, PatientDao patientDao) {
	...
	public ArrayList<Seance> listeSeancesValideesSuiv(HttpServletRequest request) {

		ArrayList<Seance> Seances = new ArrayList<Seance>();

		ArrayList<Seance> SeancesSuiv = new ArrayList<Seance>();
