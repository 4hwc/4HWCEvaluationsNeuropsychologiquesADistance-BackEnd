...
public final class RealisationDessinRecopierMmseForm {
	...
	public RealisationDessinRecopierMmseForm(MedecinDao medecinDao, PatientDao patientDao, MmseDao mmseDao) {
	...
	public void Action(HttpServletRequest request) {
		...
		if (session.getAttribute(ATT_SESSION_PATIENT) != null) {
			...
			mmseDao.clic_pat_dessin_recopier(id_aleatoire_mmse);
