...
public final class ResultatsBrefChronoCroissantUniqueForm {
	...
	public ResultatsBrefChronoCroissantUniqueForm(BrefDao brefDao) {
	...
	public void ListeDesResBrefUnique(HttpServletRequest request) {
		...
		liste = brefDao.trouver_bref_chrono_croissant_unique(identimed, identipat);
