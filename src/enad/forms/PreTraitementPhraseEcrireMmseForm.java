...
public final class PreTraitementPhraseEcrireMmseForm {

	private MmseDao mmseDao;

	public PreTraitementPhraseEcrireMmseForm(MmseDao mmseDao) {
	...
	public void Action(HttpServletRequest request) {
		...
		if (mmseDao.CompteurPreTraitementPhraseEcrireMmse(id_aleatoire, identifiantmed, identifiantpat) == 0) {
			...
			mmseDao.creerPreTraitementPhraseEcrireMmse(id_aleatoire, identifiantmed, identifiantpat);
