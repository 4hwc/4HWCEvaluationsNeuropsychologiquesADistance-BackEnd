...
public final class CreationPropositionSeancesPatientForm {
	...
	public CreationPropositionSeancesPatientForm(SeanceDao seanceDao, PropositionSeanceDao propositionseanceDao,
	...
	public PropositionSeance creerPropositionSeance(HttpServletRequest request) {
		...
		try {
			...
			if (erreurs.isEmpty()) {
				...
				propositionseanceDao.creerPat(seance, propseance, patient);
