...
public final class ResultatsMmseChronoDecroissantUniqueForm {
	...
	public ResultatsMmseChronoDecroissantUniqueForm(MmseDao mmseDao) {
	...
	public void ListeDesResMmseUnique(HttpServletRequest request) {
		...
		liste = mmseDao.trouver_mmse_chrono_decroissant_unique(identimed, identipat);
