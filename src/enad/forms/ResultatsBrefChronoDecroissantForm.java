...
public final class ResultatsBrefChronoDecroissantForm {
	...
	public ResultatsBrefChronoDecroissantForm(BrefDao brefDao) {
	...
	public void ListeDesResBref(HttpServletRequest request) {
		...
		liste = brefDao.trouver_bref_chrono_decroissant(identimed);
