...
public final class ResultatsMmseDecroissantUniqueForm {
	...
	public ResultatsMmseDecroissantUniqueForm(MmseDao mmseDao) {
	...
	public void ListeDesResMmseUnique(HttpServletRequest request) {
		...
		liste = mmseDao.trouver_mmse_decroissant_unique(identimed, identipat);
