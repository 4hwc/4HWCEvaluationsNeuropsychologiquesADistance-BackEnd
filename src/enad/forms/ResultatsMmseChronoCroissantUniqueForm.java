...
public final class ResultatsMmseChronoCroissantUniqueForm {
	...
	public ResultatsMmseChronoCroissantUniqueForm(MmseDao mmseDao) {
	...
	public void ListeDesResMmseUnique(HttpServletRequest request) {
		...
		liste = mmseDao.trouver_mmse_chrono_croissant_unique(identimed, identipat);
