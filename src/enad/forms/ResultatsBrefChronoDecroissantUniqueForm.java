...
public final class ResultatsBrefChronoDecroissantUniqueForm {
	...
	public ResultatsBrefChronoDecroissantUniqueForm(BrefDao brefDao) {
	...
	public void ListeDesResBrefUnique(HttpServletRequest request) {
		...
		liste = brefDao.trouver_bref_chrono_decroissant_unique(identimed, identipat);
