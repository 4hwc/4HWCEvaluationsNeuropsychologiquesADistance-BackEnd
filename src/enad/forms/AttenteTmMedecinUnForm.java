...
public final class AttenteTmMedecinUnForm {
	...
	public String clic_pat_tm_un = "non";

	public Seance seance_tm_un;

	public String sexe;

	public AttenteTmMedecinUnForm(MedecinDao medecinDao, PatientDao patientDao, SeanceDao seanceDao) {
	...
	public void ClicPatOuPas(HttpServletRequest request) {
		...
		seance_tm_un = seanceDao.trouver_seance_de_cet_id(id);

		if (seanceDao.clic_patient_ou_pas_tm_un(id) == 0) {
