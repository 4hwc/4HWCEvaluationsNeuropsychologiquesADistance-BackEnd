...
public final class ValidationPropositionSeanceMedecinForm {
	...
	public ValidationPropositionSeanceMedecinForm(MedecinDao medecinDao, PropositionSeanceDao propositionseanceDao,
			SeanceDao seanceDao) {
