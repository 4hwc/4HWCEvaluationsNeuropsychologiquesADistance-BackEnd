...
public final class DiaporamaTMUnForm {
	...
	public DiaporamaTMUnForm(PatientDao patientDao, SeanceDao seanceDao, MedecinDao medecinDao,
	...
	public void ListeDesImagesTm(HttpServletRequest request) {
		...
		liste = imagetesttmbeanDao.ImageTestTmUnBean_seance(id);
