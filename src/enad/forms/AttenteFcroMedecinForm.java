...
public final class AttenteFcroMedecinForm {
	...
	public String clic_pat = "non";

	public Seance seance;

	public String sexe;

	public AttenteFcroMedecinForm(MedecinDao medecinDao, PatientDao patientDao, SeanceDao seanceDao) {
	...
	public void ClicPatOuPas(HttpServletRequest request) {
		...
		seance = seanceDao.trouver_seance_de_cet_id(id);

		if (seanceDao.clic_patient_ou_pas(id) == 0) {
