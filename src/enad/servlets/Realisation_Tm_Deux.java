...
import enad.forms.Realisation_Tm_DeuxForm;

public class Realisation_Tm_Deux extends HttpServlet {
	...
	public static final String REALISATION_FCRO = "/WEB-INF/RealisationTmDeux.jsp";
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Realisation_Tm_DeuxForm form = new Realisation_Tm_DeuxForm(medecinDao, patientDao, seanceDao);
		...
		request.setAttribute("type_tm", "deux");
