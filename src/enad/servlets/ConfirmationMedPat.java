...
import enad.forms.ConfirmationMedPatForm;

public class ConfirmationMedPat extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ConfirmationMedPatForm form = new ConfirmationMedPatForm(medecinDao, patientDao);

		form.ConfirmationRelMedPat(request);
