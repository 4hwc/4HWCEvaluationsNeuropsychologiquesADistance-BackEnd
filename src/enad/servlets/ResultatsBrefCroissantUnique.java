...
import enad.forms.ResultatsBrefCroissantUniqueForm;

public class ResultatsBrefCroissantUnique extends HttpServlet {

	private BrefDao brefDao;

	public static final String CONF_DAO_FACTORY = "daofactory";

	public static final String RESULTATS_BREF = "/WEB-INF/listeResultatsBrefCroissantUnique.jsp";
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ResultatsBrefCroissantUniqueForm form = new ResultatsBrefCroissantUniqueForm(brefDao);
