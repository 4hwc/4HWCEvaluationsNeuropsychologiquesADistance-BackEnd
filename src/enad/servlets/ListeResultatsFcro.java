...
import enad.forms.ListeResultatsFcroForm;

public class ListeResultatsFcro extends HttpServlet {
	...
	public static final String RESULTATS_FCRO = "/WEB-INF/listeResultatsFcro.jsp";
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ListeResultatsFcroForm form = new ListeResultatsFcroForm(patientDao, seanceDao, medecinDao,
				imagetestfcrobeanDao);

		ArrayList<Seance> SeancesDansDossierImagesFcro = form.ListeDesSeancesFcroDuMed(request);

		request.setAttribute("SeancesDansDossierImagesFcro", SeancesDansDossierImagesFcro);

		/*
		 * A la réception d'une requête GET, simple affichage de la page
		 */

		this.getServletContext().getRequestDispatcher(RESULTATS_FCRO).forward(request, response);
	}
