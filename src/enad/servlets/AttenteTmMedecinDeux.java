...
import enad.forms.AttenteTmMedecinDeuxForm;

public class AttenteTmMedecinDeux extends HttpServlet {

	public static final String ATTENTE_TM_UN_MEDECIN = "/WEB-INF/AttenteTmMedecinDeux.jsp";
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		AttenteTmMedecinDeuxForm form = new AttenteTmMedecinDeuxForm(medecinDao, patientDao, seanceDao);

		form.ClicMedTmDeux(request);

		form.ClicPatOuPas(request);

		form.SexePatient(request);

		request.setAttribute("clic_pat", form.clic_pat_tm_deux);

		request.setAttribute("seance", form.seance_tm_deux);
