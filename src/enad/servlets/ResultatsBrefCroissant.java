...
import enad.forms.ResultatsBrefCroissantForm;

public class ResultatsBrefCroissant extends HttpServlet {

	private BrefDao brefDao;

	public static final String CONF_DAO_FACTORY = "daofactory";

	public static final String RESULTATS_BREF = "/WEB-INF/listeResultatsBrefCroissant.jsp";
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ResultatsBrefCroissantForm form = new ResultatsBrefCroissantForm(brefDao);
