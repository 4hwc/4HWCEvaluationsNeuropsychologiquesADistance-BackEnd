...
import enad.forms.ResultatsBrefDecroissantForm;

public class ResultatsBrefDecroissant extends HttpServlet {

	private BrefDao brefDao;

	public static final String CONF_DAO_FACTORY = "daofactory";

	public static final String RESULTATS_BREF = "/WEB-INF/listeResultatsBrefDecroissant.jsp";
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ResultatsBrefDecroissantForm form = new ResultatsBrefDecroissantForm(brefDao);
