...
import enad.forms.ResultatsBrefChronoCroissantForm;

public class ResultatsBrefChronoCroissant extends HttpServlet {

	private BrefDao brefDao;

	public static final String CONF_DAO_FACTORY = "daofactory";

	public static final String RESULTATS_BREF = "/WEB-INF/listeResultatsBrefChronoCroissant.jsp";
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ResultatsBrefChronoCroissantForm form = new ResultatsBrefChronoCroissantForm(brefDao);
