...
import enad.forms.DiaporamaTMUnForm;

public class DiaporamaTMUn extends HttpServlet {
	...
	public static final String INFORMATIONS_TM = "/WEB-INF/diaporamaTMUn.jsp";
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		DiaporamaTMUnForm form = new DiaporamaTMUnForm(patientDao, seanceDao, medecinDao, imagetesttmbeanDao);
