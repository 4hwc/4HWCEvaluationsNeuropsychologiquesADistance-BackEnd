...
import enad.forms.Envoyer_Tm_Au_PatientDeuxForm;

public class Envoyer_Tm_Au_Patient_Deux extends HttpServlet {
	...
	public static final String ENVOYER_FCRO = "/WEB-INF/envoyerTmAuPatientDeux.jsp";
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Envoyer_Tm_Au_PatientDeuxForm form = new Envoyer_Tm_Au_PatientDeuxForm(seanceDao, patientDao);
