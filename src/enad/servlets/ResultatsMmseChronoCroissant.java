...
import enad.forms.ResultatsMmseChronoCroissantForm;

public class ResultatsMmseChronoCroissant extends HttpServlet {

	private MmseDao mmseDao;

	public static final String CONF_DAO_FACTORY = "daofactory";

	public static final String RESULTATS_MMSE = "/WEB-INF/listeResultatsMmseChronoCroissant.jsp";
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ResultatsMmseChronoCroissantForm form = new ResultatsMmseChronoCroissantForm(mmseDao);
