...
import enad.forms.ConfirmationMedMedForm;

public class ConfirmationMedMed extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ConfirmationMedMedForm form = new ConfirmationMedMedForm(medecinDao);

		form.ConfirmationRelMedMed(request);
