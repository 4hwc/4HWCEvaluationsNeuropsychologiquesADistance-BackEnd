...
public class ImageMmsePraxiesConstructives extends HttpServlet {

	public static final int TAILLE_TAMPON = 10240; // 10ko

	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		/*
		 * Lecture du paramètre 'cheminmmselangage' passé à la servlet via la
		 * déclaration dans le web.xml
		 */

		String chemin = this.getServletConfig().getInitParameter("cheminmmsepraxiesconstructives");
		...
		if (fichierRequis == null || "/".equals(fichierRequis)) {
			/*
			 * Sinon, on envoie une erreur 404, qui signifie que la ressource
