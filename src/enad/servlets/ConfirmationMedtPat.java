...
import enad.forms.ConfirmationMedtPatForm;

public class ConfirmationMedtPat extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ConfirmationMedtPatForm form = new ConfirmationMedtPatForm(medecinDao, patientDao);

		form.ConfirmationRelMedtPat(request);
