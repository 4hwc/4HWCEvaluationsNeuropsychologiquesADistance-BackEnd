...
import enad.trainings.SpeechUtils;

/**
 * @author Admin
 *
 */
public class synthesizer_en {
	...
	public void doSpeak(String speakTest)
			throws EngineException, AudioException, IllegalArgumentException, InterruptedException {
		synthesizer.speakPlainText(speakTest, null);
		synthesizer.waitEngineState(Synthesizer.QUEUE_EMPTY);
	}

	public void speaknow() throws EngineException, AudioException, EngineStateError, PropertyVetoException,
		...
		su.doSpeak("Fanon is my father ! He works very hard for me and I am happy !");
		su.terminate();
	}
