...
public class DAOFactory {
	...
	private static final String FICHIER_PROPERTIES = "/enad/dao/dao.properties";
	...
	public PropositionSeanceDao getPropositionSeanceDao() {

		return new PropositionSeanceDaoImpl(this);
	}

	public ImageTestFcroBeanDao getImageTestFcroBeanDao() {

		return new ImageTestFcroBeanDaoImpl(this);
	}

	public ImageTestTmBeanDao getImageTestTmBeanDao() {

		return new ImageTestTmBeanDaoImpl(this);
	}

	public ImageTestTdoiBeanDao getImageTestTdoiBeanDao() {

		return new ImageTestTdoiBeanDaoImpl(this);
	}

	public BrefDao getBrefDao() {

		return new BrefDaoImpl(this);
	}

	public MmseDao getMmseDao() {

		return new MmseDaoImpl(this);
	}

	public ImageMmseLangageBeanDao getImageMmseLangageBeanDao() {

		return new ImageMmseLangageBeanDaoImpl(this);
	}

	public ImageMmsePraxiesConstructivesBeanDao getImageMmsePraxiesConstructivesBeanDao() {

		return new ImageMmsePraxiesConstructivesBeanDaoImpl(this);
	}
